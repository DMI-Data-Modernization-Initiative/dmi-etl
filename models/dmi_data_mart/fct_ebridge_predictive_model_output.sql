...
select 
	...
	popuation_tbl.population,
	ebridge_ml_output.predicted_cases,
	round((predicted_cases * 52/popuation_tbl.population * 100000), 2) as incidence,
	cast(current_date as date) as load_date
from ebridge_ml_output
left join {{ ref('sub_county_population') }} as popuation_tbl on ebridge_ml_output.subcountyid = popuation_tbl.subcounty_id
